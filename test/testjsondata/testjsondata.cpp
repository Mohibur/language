...
void TestJasonData::testTest()
{
  ...
  INFO(QString("Testing Array: ").append(QString(a)));
  int b  = (int)qjv.isBool();
  INFO(QString("Testing bool: ").append(QString(b)));
  int d = (int)qjv.isDouble();
  INFO(QString("Testing double: ").append(QString(d)));
  int n = (int)qjv.isNull();
  INFO(QString("Testing null: ").append(QString(n)));
  int o = (int)qjv.isObject();
  INFO(QString("Testing object: ").append(QString(o)));
  int s = (int)qjv.isString();
  INFO(QString("Testing String: ").append(QString(s)));
  int u = (int)qjv.isUndefined();
  INFO(QString("Testing undefined: ").append(QString(u)));
